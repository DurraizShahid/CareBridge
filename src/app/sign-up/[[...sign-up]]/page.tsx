          ...
          <div style={{ marginTop: 26 }}>
              ...
              >
                {errorMessage.includes('sign in') ? (
                  <>
                    ...
                    <Link
                      href="/sign-in"
                      style={{ fontWeight: 500, color: '#991b1b', textDecoration: 'underline', textUnderlineOffset: 2 }}
                    >
                      sign in
                    </Link>
              ...
              <>
                ...
                <form onSubmit={handleInfoSubmit} noValidate>
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                    <div>
                      <input
                        ...
                        style={focusedField === 'first-name' ? focusedInputStyle : inputStyle}
                        aria-describedby={errors?.fields?.firstName ? 'first-name-error' : undefined}
                      />
                      {errors?.fields?.firstName && (
                        <p id="first-name-error" style={{ fontSize: 12, color: '#dc2626', margin: '4px 0 0' }} role="alert">
                    ...
                    <div>
                      <input
                        ...
                        style={focusedField === 'last-name' ? focusedInputStyle : inputStyle}
                        aria-describedby={errors?.fields?.lastName ? 'last-name-error' : undefined}
                      />
                      {errors?.fields?.lastName && (
                        <p id="last-name-error" style={{ fontSize: 12, color: '#dc2626', margin: '4px 0 0' }} role="alert">
                  ...
                  <input
                    ...
                    required
                    autoComplete="email"
                    style={{ ...(focusedField === 'signup-email' ? focusedInputStyle : inputStyle), marginTop: 8 }}
                    aria-describedby={errors?.fields?.emailAddress ? 'signup-email-error' : undefined}
                  />
                  {errors?.fields?.emailAddress && (
                    <p id="signup-email-error" style={{ fontSize: 12, color: '#dc2626', margin: '4px 0 0' }} role="alert">
                  ...
                  <div style={{ position: 'relative', marginTop: 8 }}>
                    <input
                      ...
                      style={focusedField === 'signup-password' ? { ...focusedInputStyle, paddingRight: 38 } : { ...inputStyle, paddingRight: 38 }}
                  ...
                  {errors?.fields?.password && (
                    <p id="signup-password-error" style={{ fontSize: 12, color: '#dc2626', margin: '4px 0 0' }} role="alert">
            ...
            {step === 'verify' && (
              <form onSubmit={handleVerifySubmit} noValidate>
                <p style={{ fontSize: 12, color: '#8d8d8d', marginBottom: 8, marginTop: 0 }}>
                  We&apos;ve sent a 6-digit code to{' '}
                  <span style={{ fontWeight: 500, color: '#202020' }}>{emailAddress}</span>.
                </p>
                <input
                  id="verify-code"
                  type="text"
                  ...
                  maxLength={6}
                  style={{
                    ...(focusedField === 'verify-code' ? focusedInputStyle : inputStyle),
                    textAlign: 'center',
                    fontSize: 16,
                    letterSpacing: '0.3em',
                  }}
                ...
                />
                {errors?.fields?.code && (
                  <p id="verify-code-error" style={{ fontSize: 12, color: '#dc2626', margin: '4px 0 0' }} role="alert">
