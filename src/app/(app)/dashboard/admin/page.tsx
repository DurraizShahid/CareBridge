...
const roleColors: Record<string, string> = {
  ...
  administrator: "bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400",
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
        ...
        <StatCard title="Pending Approvals" value={stats.pendingApprovals} icon={AlertTriangle} variant="warmth" />
      </div>
              ...
              {Object.entries(stats.usersByRole).map(([role, count]) => {
                ...
                return (
                  <div key={role} className="flex items-center gap-3">
                    <span
                      className={cn(
                        "inline-flex w-28 shrink-0 rounded-full px-2 py-0.5 text-xs font-medium",
          ...
          <div>
            ...
            <div className="space-y-1">
              {recentActivity.slice(0, 4).map((event) => (
                ...
                >
                  <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-health/10">
                    <Activity className="h-3.5 w-3.5 text-health" />
                  </div>
                  <div className="min-w-0 flex-1">
            ...
            <div className="rounded-xl border border-border bg-card p-5 shadow-sm">
              ...
              <div className="mt-4 grid grid-cols-3 gap-4 border-t border-border pt-4">
                <div className="text-center">
                  <p className="text-lg font-bold text-foreground">{allHospitals.length}</p>
