...
export function SocialPlatformIcon({
  ...
  return (
    <span
      className={cn(
        "inline-flex size-7 shrink-0 items-center justify-center rounded-lg p-1.5",
        branded ? SOCIAL_PLATFORM_COLORS[platform] : "bg-muted text-muted-foreground",
        className,
      )}
      aria-hidden
    >
