  ...
  return (
    <div
      ...
      className={cn(
        ...
        "shadow-[inset_-1px_-1px_4px_rgba(255,255,255,0.6),inset_1px_1px_4px_rgba(0,0,0,0.1),0_10px_24px_rgba(0,0,0,0.14),-6px_0_18px_rgba(0,0,0,0.08),-4px_8px_20px_rgba(0,0,0,0.10)] dark:shadow-[inset_-1px_-1px_4px_rgba(255,255,255,0.06),inset_1px_1px_4px_rgba(0,0,0,0.3),0_10px_24px_rgba(0,0,0,0.4),-6px_0_18px_rgba(0,0,0,0.25),-4px_8px_20px_rgba(0,0,0,0.3)]",
        glass && "glass-card",
