...
const PillNav = ({
  ...
  const tlRefs = useRef<ReturnType<typeof gsap.timeline>[]>([]);
  const activeTweenRefs = useRef<ReturnType<typeof gsap.to>[]>([]);
  ...
  return (
    <div className="pill-nav-container" ref={containerRef}>
      ...
      >
        ...
        {children && <div className="pill-nav-children">{children}</div>}
