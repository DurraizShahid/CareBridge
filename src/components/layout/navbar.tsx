  ...
  return (
    <div
      className={`absolute inset-x-0 z-20 px-4 transition-all duration-300 sm:px-6 lg:px-8 ${
        scrolled
          ? "fixed top-0 bg-[#134675] dark:bg-[#0D2B4A] shadow-lg"
          : "top-0 pt-[50px]"
      }`}
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3">
        {/* Left bar - Logo + Nav links */}
        <nav className="flex h-12 items-center gap-1 rounded-full bg-[#134675] dark:bg-[#0D2B4A] px-3 sm:h-14 sm:px-4 lg:px-5">
          {/* Logo */}
        ...
        <div className="flex h-12 items-center rounded-full bg-[#134675] dark:bg-[#0D2B4A] px-2 sm:h-14 sm:px-3">
          <AuthControls />
        </div>
      </div>
    </div>
