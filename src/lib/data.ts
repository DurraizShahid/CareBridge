...
// Facilities live in the database (prisma/seed.ts + scripts/seed-facilities.ts).
// Do not keep a parallel mock facilities list here — use getFacilities() / searchFacilities().
